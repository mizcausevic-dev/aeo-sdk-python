...
### Released
- Published **aeo-sdk-python** as a public, portfolio-grade system focused on answer-engine visibility.
...
### Shipped
- Cut the first coherent internal version of **aeo-sdk-python** with stable domain objects, review surfaces, and decision outputs.
